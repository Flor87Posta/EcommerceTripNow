...
public class EcommerceApplication {
	...
	public CommandLineRunner initData(ClienteRepositorio clienteRepositorio, OrdenRepositorio ordenRepositorio, PaqueteRepositorio paqueteRepositorio, HotelRepositorio hotelRepositorio, DestinoRepositorio destinoRepositorio, PasajeRepositorio pasajeRepositorio, ExcursionRepositorio excursionRepositorio) {
		return (args) -> {
            ...
            Paquete paquete5 = new Paquete("Escapada Costera", 9, destino5.getPrecioHotelExcursion()+pasaje5.getPrecioPasaje(), 10, "/assets/Glaciar2.jpg","/assets/Glaciar2.jpg","/assets/Glaciar2.jpg");
			Paquete paquete6 = new Paquete("Trilogía de Destinos: Mar, Sierras y Colores", 8, destino6.getPrecioHotelExcursion()+pasaje6.getPrecioPasaje(), 10, "/assets/Glaciar2.jpg","/assets/Glaciar2.jpg","/assets/Glaciar2.jpg");
			Paquete paquete7 = new Paquete("Descubriendo el Encanto de Carlos Paz", 5, destino7.getPrecioHotelExcursion()+pasaje2.getPrecioPasaje(), 10, "/assets/Glaciar2.jpg","/assets/Glaciar2.jpg","/assets/Glaciar2.jpg");
			Paquete paquete8 = new Paquete("Experiencia Multicolor en el Cerro de los Siete Colores", 15, destino8.getPrecioHotelExcursion()+pasaje1.getPrecioPasaje(), 10, "/assets/Glaciar2.jpg","/assets/Glaciar2.jpg","/assets/Glaciar2.jpg");
